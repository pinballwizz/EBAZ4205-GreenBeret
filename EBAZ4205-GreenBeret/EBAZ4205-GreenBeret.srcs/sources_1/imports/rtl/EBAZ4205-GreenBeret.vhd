...
end greenberet_ebaz4205;
------------------------------------------------------------------------------
architecture struct of greenberet_ebaz4205 is
...
INP0 <= SW_FIRE & SW_BOMB & SW_LEFT & SW_DOWN & SW_RIGHT & SW_UP;
INP1 <= SW_FIRE & SW_BOMB & SW_LEFT & SW_DOWN & SW_RIGHT & SW_UP;
INP2 <= SW_COIN & P2_START & P1_START;
---------------------------------------------------------------------------
-- Main

pm : entity work.FPGA_GreenBeret
port map (
RESET => reset,
clk48M  => clock_48,
PH    => hpos,
