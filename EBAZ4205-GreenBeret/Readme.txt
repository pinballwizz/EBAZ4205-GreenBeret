...
Build:
* Obtain correct roms file for Green Beret (see scripts in tools folder for rom details).
* Unzip rom files to the tools folder.
* Run the make Green Beret proms script in the tools folder.
* Place the generated prom files inside the proms folder.
* Open the EBAZ4205-Greenberet project file using Vivado (v2022.2 or silimar is recommended)
