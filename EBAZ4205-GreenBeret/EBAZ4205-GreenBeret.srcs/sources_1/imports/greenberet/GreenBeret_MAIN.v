...
//`include "HIDDEF.i"
wire [7:0]	ISYS = ~{1'b0,1'b0,1'b0,INP2[1],INP2[0],1'b0,1'b0,INP2[2]};
wire [7:0]	IP01 = ~{1'b0,1'b0,INP0[5],INP0[4],INP0[2],INP0[0],INP0[1],INP0[3]};
wire [7:0]	IP02 = ~{1'b0,1'b0,INP1[5],INP1[4],INP1[2],INP1[0],INP1[1],INP1[3]};
